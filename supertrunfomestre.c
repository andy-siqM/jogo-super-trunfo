...
// Incluir lógica de comparação entre as duas cartas do Super Trunfo
// Determine a vencedora de cada batalha e um super poder!
// A população deve ser armazenada como unsigned long int para acomodar números maiores
